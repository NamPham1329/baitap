...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="../project/view/front-end/assets/favicon.ico" />
        <!-- Bootstrap icons-->
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" style="margin-left: 10px;">
                        <button class="btn btn-outline-dark" type="submit">
                            <a class="link" style="color: #000; text-decoration: none;" href="/project/home/rlogin">
                                Login
                            </a>
                        </button>
                    </form>
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            <form method="POST" action="addToCart" class="d-flex" style="margin-left: 10px;" onsubmit="return deleteItem();">
